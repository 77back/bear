...
import { dayStat, isAllDone, buildCheckin } from '@shared/checkin'
import { starterTemplate, materializeTasks } from '@shared/planner'
import { buildMonthCalendar, weekHead, type CalCell } from '@shared/calendar'

/**
 * 今日任务 / 打卡 / 日历 store（与网页版 stores/task.ts 行为一致）。
 */
